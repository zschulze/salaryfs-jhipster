package com.zachschulze.salaryfs.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            cm.createCache(com.zachschulze.salaryfs.repository.UserRepository.USERS_BY_LOGIN_CACHE, jcacheConfiguration);
            cm.createCache(com.zachschulze.salaryfs.repository.UserRepository.USERS_BY_EMAIL_CACHE, jcacheConfiguration);
